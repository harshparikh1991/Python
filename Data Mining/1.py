...
def youtube_search(options):
    ...
    search_response = youtube.search().list(q=options.q, part="id,snippet", maxResults=options.max_results, publishedAfter="2017-02-13T00:00:00Z", publishedBefore="2017-02-14T00:00:00Z").execute()    
    ...
    while ('nextPageToken' in search_response):
        if(row <= 5000):
            ...
            nextPage = youtube.search().list(q=options.q, part="id,snippet", maxResults=options.max_results, pageToken=nextPageToken, publishedAfter="2017-02-13T00:00:00Z", publishedBefore="2017-02-14T00:00:00Z").execute()
