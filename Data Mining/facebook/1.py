...
def connect_db():
    ...
    connection = mysql.connector.connect(user='root', password='',host = '127.0.0.1', database='facebook_data')
    return connection
...
def main():
    ...
    APP_SECRET = "46bac3b625e0460fd296798d8b4f2299"
    APP_ID = "1956220727934888"
